...
class MainActivity : AppCompatActivity() {
    ...
    fun dialog(hasil:String){
        ...
        val viewdialog = LayoutInflater.from(this@MainActivity).inflate(R.layout.dialog_hasil,null,true)
        val dialogBuilder = AlertDialog.Builder(this@MainActivity)
        dialogBuilder.setView(viewdialog)
        dialogBuilder.setCancelable(false)

        viewdialog.findViewById<TextView>(R.id.txtYangMenang).text = hasil
        val dialog = dialogBuilder.create()
        dialog.show()
        viewdialog.findViewById<Button>(R.id.btnMainlagi).setOnClickListener {
            dialog.dismiss()
            backgroundT()
        }
        viewdialog.findViewById<Button>(R.id.btnKembali).setOnClickListener {
            finish()
        }
    }
